...
public class MemoController {
	...
	public String insert(
			@ModelAttribute("memoDTO") MemoDTO memo, 
	...
	/*
	 * 첨부파일이 있는 프로젝트에서
	 * form의 file input box type의 이름은 절대 VO(DTO) 클래스에
	 * 선언된 이름을 사용하면 안된다!
	 */
	...
	public String update(
		...
		// 로그인된 사용자의 이름을 memoDTO에 setting하기
		memoDTO.setM_author(username);
		// 주소에 따라온 seq 변수값을 추출하여 memoDTO에 setting 하기
		long m_seq = Long.valueOf(seq);
