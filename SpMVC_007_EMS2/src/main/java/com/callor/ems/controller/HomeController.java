...
public class HomeController {
	 ...
	 * 
	 * 보통 파일 업로드를 받을 때는 파일정보를 수신할 매개변수에
	 * @RequestParam() 을 사용한다
	 * 
	 * 하지만 여러파일을 수신하는
	 * MultipartHttpServletRequest를 매개변수로 사용할 때는
	 ...
	 * 2. 매개변수가 숫자형 일 때 client에서 변수에 값을 담지 않고 요청을 하면
	 * 		내부 오류가 발생한다. 이 때 required를 false로 선언하고 defaultValue를 설정하면 오류를 일부 방지할 수 있다
	 */
	@ResponseBody
