...
/*
 * Spring 3.x에서 새롭게 추가된 RestTemplate 클래스를 사용하여
 * JSON으로 응답받은 데이터를 한번에 VO 리스트로 변환하기 위한
 * Wrapper 클래스 선언
 * VO를 감싸고 있는 클래스
 * 
