...
public class StudentController {
	...
	/*
	 * @ResponseBody
	 * Controller method에서 문자열을 return 하면
	 * 문자열을 web client에게 그대로 전송하는 역할을 하도록
	 * 지시하는 Annotation이다
	 * 
	 * pom.xml에 jackson-bind Dependency를 추가하면
	 * List, 객체(VO) 등등의 데이터를 json type으로
	 * 변환하여 web client로 전송한다
	 */
	@ResponseBody
