...
public class StudentController {
	...
	/*
	 * student/update?st_num=S001 로 input form에서 저장 버튼을 클릭했을 때 form에 action이 설정되어 있지
	 * 않기 때문에 POST 전송도 같은 주소로 요청이 된다 이때 주소창에 st_num=S001이라는 변수가 설정되어 있기 때문에
	 * 
	 * form에 st_num 항목을 설정하지 않아도 StudentVO 의 st_num 변수에 학번이 자동으로 담기게 된다
	 */
